...
const mockChallenges: Challenge[] = [
  {
    ...
    category: { id: '1', name: 'Still Life', color: '#8B5CF6' },
  ...
  },
  {
    ...
    category: { id: '2', name: 'Fantasy', color: '#EC4899' },
    _count: { submissions: 156 }
  },
  {
    id: '3',
    ...
    category: { id: '3', name: 'Portrait', color: '#F59E0B' },
    _count: { submissions: 89 }
  }
];
...
const mockSubmissions: ChallengeSubmission[] = [
  {
    ...
    userId: '1',
    title: 'Morning Brew',
    description: 'My take on the daily coffee challenge with some steam effects!',
    imageUrl: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400',
    likes: 12,
    isPublic: true,
    submittedAt: new Date('2024-01-15T10:30:00'),
    challenge: mockChallenges[0],
    user: { id: '1', name: 'Sarah Artist', photo: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100' }
  },
  {
    id: '2',
    challengeId: '2',
    userId: '2',
    title: 'Floating Realms',
    description: 'A mystical landscape with floating islands and magical waterfalls.',
    imageUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400',
    likes: 45,
    isPublic: true,
    submittedAt: new Date('2024-01-16T14:20:00'),
    challenge: mockChallenges[1],
    user: { id: '2', name: 'Mike Creator', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100' }
  }
];

export const ChallengesMock: React.FC<ChallengesProps> = ({ userId, onStartDrawing }) => {
  ...
  const currentChallenge = mockChallenges[0]; // First challenge as current
  ...
  const filteredChallenges = mockChallenges.filter(challenge => {
    if (selectedCategory && challenge.category.name.toLowerCase() !== selectedCategory.toLowerCase()) return false;
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) => setSubmissionForm(prev => ({ ...prev, isPublic: e.target.checked }))}
